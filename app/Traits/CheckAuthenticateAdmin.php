...
trait CheckAuthenticateAdmin
{
    ...
    protected function validateLogin(Request $request)
    {
        ...
        Validator::extend('checkadmin', function ($attribute, $value, $parameters, $validator) {

     
        $user = User::where('email',Input::get('email'))->with('userprofile')->first(); 
            ...
            return false;
        }, trans('auth.admin_error'));



        $this->validate($request, [
            $this->username() => 'required|string|checkadmin',
    ...
    protected function authenticated(Request $request, $user)
    {
       // dd(auth()->check() && auth()->user()->userprofile->usergroup_id);
        ...
        {
          // dd('authenti');
            $this->createAuthentication($user,$request,'admin');         
