...
class CoinTransactionServerUser extends Command
{
  use Common;
  /**
   ...
   * @var string
   */
  protected $signature = 'exchange:gettransactionserveruser {userid}';
   ...
   * @var string
   */
  protected $description = 'Coin Transaction Server User';
