...
class FaqCrudController extends CrudController
{
    ...
    public function setUp()
    {
        ...
        */
        ...
        $this->crud->addField($faqtitle, 'update/create/both');
        $this->crud->addColumn($faqtitle);
        ...
        $this->crud->addField($faqdesc, 'update/create/both');
        $this->crud->addColumn($faqdesc);
        $faqorder = [
                'name' => 'order',
                'label' => "Order By",
                'type' => 'text',
        ...
        $this->crud->addField($faqorder, 'update/create/both');
        $this->crud->addColumn($faqorder);
       ...
       $this->crud->addColumn('language');
        ...
        $this->crud->addField($faqstatus, 'update/create/both');
        $this->crud->addColumn($faqstatus);
