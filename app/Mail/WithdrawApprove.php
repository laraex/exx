...
class WithdrawApprove extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
       ...
       // $user = User::where('id', Auth::id())->with('userprofile')->first();
        ...
        //             ->with([
        //                 'comments' => $this->withdraw->comments_on_complete,
        ...
        $kycverified = Mailtemplate::where([['name','withdraw_approve'],['status','active']])->first();
        ...
        $mail_content = str_replace(":comments",$this->withdraw->comments_on_complete,$mail_content);
