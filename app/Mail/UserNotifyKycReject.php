...
class UserNotifyKycReject extends Mailable implements ShouldQueue
{
    ...
    { 
        $admin = User::find(1);
        // return $this->markdown('emails.KYC.usernotifykycreject')
        //             ->with([
        //                 'admin' => $admin->name,
        ...
        $kycverified = Mailtemplate::where([['name','user_notify_kycreject'],['status','active']])->first();
