...
<form method="post" action="{{ url('staff/updatechangepassword')}}" class="form-horizontal" id="change_password">
...
{{ csrf_field() }}
    ...
    <div class="form-group">
        ...
        <a href="{{ url('staff/changepassword') }}" class='btn btn-default'>{{ trans('forms.reset') }}</a>
    </div>
