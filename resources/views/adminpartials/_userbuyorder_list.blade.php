<div class="tab-container">
	<h3>{{ trans('admin_user.buy_order_list') }}</h3>
	<table class="table table-bordered" id="buyorderlistsdatatable">
	    <thead>
		    <tr>
	    ...
	    <tbody>
		       	@if(count($buyorderlists) > 0)
           @foreach($buyorderlists as $buyorder)
                <tr>
...
<script>
    $(document).ready(function(){
        $('#buyorderlistsdatatable').DataTable();
